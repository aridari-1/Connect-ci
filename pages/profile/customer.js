    ...
    <div className="max-w-xl mx-auto bg-[#13151A] rounded-2xl shadow-lg 
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm sm:text-base text-slate-400">Client Connect</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-3 sm:gap-4 text-center">
        <div className="p-3 sm:p-4 bg-[#0B0C10] rounded-xl border border-slate-700">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400">Demandes</p>
        </div>
        ...
        <div className="p-3 sm:p-4 bg-[#0B0C10] rounded-xl border border-slate-700">
          ...
          <p className="text-[10px] sm:text-xs text-slate-400">Terminées</p>
        </div>
